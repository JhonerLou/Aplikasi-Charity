    ...
    <div class="w-full min-h-screen py-10 px-4 sm:px-6 lg:px-8">
        ...
        @if($campaign->isEmpty())
            <div class="bg-white p-10 text-center rounded-lg shadow-lg max-w-2xl mx-auto">
                ...
                <h3 class="text-2xl font-medium text-gray-800 mb-2">No campaigns available yet</h3>
                <p class="text-gray-600 mb-6">Be the first to create a meaningful campaign</p>
